...
class HelpCenterPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildExpansionTile(
            l10n.modifyAddress,
            l10n.modifyAddressAns,
          ),
          _buildExpansionTile(
            l10n.setupAddress,
            l10n.setupAddressAns,
          ),
         ...
         _buildSectionHeader(l10n.faqGetDeliverers),
          ...
          _buildExpansionTile(
            l10n.faqClientAbsent,
            l10n.faqClientAbsentAns,
          ),
  ...
  Future<void> _contactSupport(BuildContext context) async {
    // Remplacez par votre numéro WhatsApp ou email réel
  final Uri whatsappLaunchUri = Uri(
  scheme: 'https',
  host: 'wa.me',
  path: '+237657519744',
  query: 'text=Bonjour, j\'ai besoin d\'assistance pour Camelia Logistics',
);
      ...
      child: ExpansionTile(
        ...
        children: [
          Padding(
            ...
            child: Text(
              answer,
              style: GoogleFonts.poppins(color: Colors.grey.shade600, height: 1.5, fontSize: 13),
            ),
          ),
        ],
      ),
